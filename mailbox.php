...
$sql="SELECT * FROM usermail where to_id='$id'";
$dd=$conn->query($sql);
if($dd)
{
  ...
  //echo "<tr><td style="text-align:center"> <strong>Check </stron></td><td style="text-align:center"> <strong> Receiver</strong> </td><td style="text-align:center"> <strong> Subject</strong></td><td style="text-align:center"> <strong> Date</strong></td></tr>";
	echo "<tr><th> Check</th><th> Receiver </th><th> Subject </th><th> Date</th></tr>";
while(list($mid,$rid,$sid,$s,$m,$d)=$dd->fetch_array())
{
	echo "<tr>";
