...
if(isset($_POST['signIn']))
{
	...
	{
		$d=$conn->query("SELECT * FROM userinfo where emailid='{$_POST['id']}' and password='{$_POST['pwd']}'");
		if($d->num_rows>0)
		{
...
<form method="post">
  ...
  <div class="container">
    ...
    <input type="text" placeholder="Enter Email ID" name="id" pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required>
